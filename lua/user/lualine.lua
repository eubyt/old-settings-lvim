...
M.config = function()
            ...
            lualine_c = {{
                ...
                color = function()
                    return {
                        ...
                        bg = lvim.transparent_window and "NONE" or colors.bg_alt
                    }
                end,
                padding = {
                    left = 1,
    ...
    ins_left {
        function()
            vim.api.nvim_command("hi! LualineFileIconColor guifg=" .. get_file_icon_color() .. " guibg=" ..
                                     (lvim.transparent_window and "none" or colors.bg) .. " gui=bold")
    ...
    ins_left {
        function()
            ...
            if string.find(fname, "term") ~= nil and string.find(fname, "lazygit;#toggleterm") ~= nil and
                (vim.fn.has "linux" == 1 or vim.fn.has "mac" == 1) then
    ...
    ins_left {
        function()
            return lvim.transparent_window and " " or ""
        end,
        padding = {
            left = 0,
            right = 0
